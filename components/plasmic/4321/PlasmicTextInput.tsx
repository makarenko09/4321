...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: tNLSavb_bjyo/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames("all", sty.svg__gYnWo)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames("all", "input", "input__3HUGj", sty.input, {
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames("all", sty.svg__db6Tl)}
              role={"img"}
            />
          ),
