...
import sty from "./PlasmicTeams.module.css"; // plasmic-import: 4Pw2Zus1IS1l/css
    ...
    >
      ...
      >
        <PlasmicImg__
          ...
          loading={"lazy"}
          src={{
            src: "/plasmic/4321/images/teamPng.png",
            fullWidth: 128,
            fullHeight: 128,
        ...
        <div className={classNames("all", "__wab_text", sty.text__u9NIq)}>
          {"Jocylne Kujo"}
        </div>
        <div className={classNames("all", "__wab_text", sty.text___1KTtH)}>
          {"Founder Flappin"}
        </div>
        <div className={classNames("all", "__wab_text", sty.text___7N88)}>
          {
